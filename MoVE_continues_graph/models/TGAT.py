...
# from utils import stochastic_transforms
...
class TGAT(nn.Module):
    ...
    def __init__(self, node_raw_features: np.ndarray, edge_raw_features: np.ndarray, neighbor_sampler: NeighborSampler,
        ...
        self.Noisy_node_feat = stochastic_transforms.NoisyNodeFeat()
        self.Drop_edge = stochastic_transforms.DropEdge()
        self.Drop_node = stochastic_transforms.DropNode()
        self.Time_shift = stochastic_transforms.TimeShift()
